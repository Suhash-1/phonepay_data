...
/* Sidebar and top navigation text */
...
select = option_menu(
    ...
    default_index=0,
    styles={
        "container": {"padding": "0!important", "background-color": "#5f259f"},
        ...
        "nav-link-select": {"background-color": "#ff4b4b"},
    }
)

# Database config (PostgreSQL)
engine = create_engine("postgresql+psycopg2://postgres:suhash@localhost:5432/phonepay_db")
...
def question1():
    ...
    fig_brand= px.pie(brand2, values= "transaction_count", names= "Brands", color_discrete_sequence=px.colors.sequential.Mint_r,
                        title= "Top Mobile Brands of Transaction_count")
    st.plotly_chart(fig_brand)
    return

def question2():
    lt= agg_tran_df[["State", "transaction_amount"]]
...
# Main Content
if select == "HOME":
    st.markdown("<h1 style='text-align: center; color: purple;'>Welcome to PhonePe</h1>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: center;'>Recharge, Pay Bills, Send Money & More</h4>", unsafe_allow_html=True)
...
# Additional Services Section
    ...
    # Footer
        st.markdown("<p style='text-align:center; color:grey;'>© 2025 PhonePe. All rights reserved.</p>", unsafe_allow_html=True)
    ...
    st.markdown("<h4 style='color:#FF4B4B;'>Select the Question</h4>", unsafe_allow_html=True)
